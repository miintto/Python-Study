...
def form_triangle(pt1, pt2, pt3):
    '''
    3차원 상의 점 3개를 입력하면
    그 점이 이루는 평면의 법선벡터를 추가하여
    삼각형 오브젝트를 출력
    '''
    x = [pt1[i]-pt2[i] for i in range(3)]
    y = [pt1[i]-pt3[i] for i in range(3)]

    return    [pt1, pt2, pt3, crss_prd(x, y)]
